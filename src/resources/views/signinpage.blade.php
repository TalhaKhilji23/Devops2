...
<body>
    ...
    <div class="container cont2 justify-content-center" style="width: 400px;">
        ...
        <form method="POST" action="{{route('login')}}">
            ...
            <button type="submit" class="btn butto">Sign In</button>
            <p class="text-center text-muted" style="margin-top: 10px;">Don't have an account yet? <a href="#!"><u>Register</u></a></p>
        </form>
    </div>
