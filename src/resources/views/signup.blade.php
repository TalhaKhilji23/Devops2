        ...
        <h1>Register now</h1>
            ...
            @csrf
                <div class="mb-3">
                    ...
                    <input required type="text" class="form-control" onkeyup="validate(this)" name="name" id="name">
                    <div id="nameerror"></div>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input required type="text" class="form-control" onkeyup="validate(this)" name="email" id="email">
                    <div id="emailerror"></div>
                </div>
                <div class="mb-3">
                    <label for="password" class="form-label">Password</label>
                    <input required type="password" placeholder="mina1234" class="form-control" onkeyup="validate(this)" name="password" id="password">
                    <div id="passworderror"></div>
                </div>
                <div class="mb-3">
                    <label for="country" class="form-label">Country</label>
                    <input required type="text" class="form-control" onkeyup="validate(this)" name="country" id="country">
                    <div id="countryerror"></div>
                </div>
                <div class="mb-3">
                    <label for="address" class="form-label">Address</label>
                    <input required type="text" class="form-control" onkeyup="validate(this)" name="address" id="address">
 ...
 <script>
    function validate(field){
        const patterns = {
            ...
            address: new RegExp("^[a-zA-Z0-9]{5,30}$"),
            country: new RegExp("^[a-zA-Z]{5,20}$"),
        ...
        if (patterns[field.name].test(field.value)){
            ...
            document.getElementById(field.name).style.borderColor = "blue";
        }
        else{
            document.getElementById(field.name+'error').innerHTML = "Invalid "+field.name;
