  ...
  <div class="container con29">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td>{{$user->country}}</td>
        <td>{{$user->address}}</td>
        <td><a href="/updateform/{{$user->id}}">Update</a></td>
      ...
      // foreach ($userlist as $AData) {

      //   print "<tr>";
      //   print "<td>" . $AData->name . "</td>";
      //   print "<td>" . $AData->email . "</td>";
      //   print "<td>" . $AData->country . "</td>";
      //   print "<td>" . $AData->address . "</td>";
      //   print '<td><a href="/updateform/'.$AData->id.'">edit</a> </td>';
      //   print '<td><a href="/deleteUser/{{$AData->id}}">Delete</a></td>';
      //   print "</tr>";
      // }
      ?> -->
    </table>
