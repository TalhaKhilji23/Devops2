    ...
    <div class="container cont2 justify-content-center" style="width: 1000px;">
        ...
        @csrf <!-- {{ csrf_field() }} -->
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="budget" id="budget" value="{{$detail->budget}}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="4">{{$detail->description}}</textarea>
            </div>
